...
There is an alternative way to enable `write permissions` for the token instead of changing the Repository Settings. Required permissions could be added like this -
